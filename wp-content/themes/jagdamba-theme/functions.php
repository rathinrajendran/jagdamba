...
function gallery_page_meta_box($post)
{
...
add_action("add_meta_boxes_page", "gallery_page_meta_box");
...
function jagdamba_product_category_meta_box()
{
  add_meta_box(
    'jagdamba_product_category',
    'Product Category',
    'jagdamba_product_category_callback',
    'products',
    'side',
    'high'
  );
...
add_action(
  'add_meta_boxes',
  'jagdamba_product_category_meta_box'
);

/* --------------------------------------------------------------------------
   PRODUCT CATEGORY SELECTION LOGIC
   -------------------------------------------------------------------------- */
function jagdamba_product_category_callback($post)
{
  $selected_category = get_post_meta($post->ID, '_product_category', true);
...
?>
  <select name="product_category" style="width:100%;padding:8px;">
...
function jagdamba_save_product_category($post_id)
{
...
add_action(
  'save_post_products',
  'jagdamba_save_product_category'
);
